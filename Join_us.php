<?php
    ...
    if(isset($_SESSION['username']) && isset($_SESSION['password'])){
        require "join_us_print_data.php";
...
<body>
    <section class="all_pages_data">
        ...
        <section class="home_page_data">
                <h1 class="h1_home_page_text">Join Us page Image and text</h1>
                <form action="join_us_database_insert.php" method="POST" enctype="multipart/form-data">
                ...
                <div id="overflowTest">
                    ...
                    <?php
                            ...
                            foreach ($items as $item) {
                                ...
                                $text = $item['text'];
                                ?>
                                <form action="join_us_del_database.php?id=<?php echo $id ?>" class="f_right" method="post" enctype="multipart/form-data">
                                    <button type="submit">Delete</button>
                                </form>
                                <form action="join_us_data_update.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
                                    <div class="div">
                                        <div class="image">
                                            <div>
